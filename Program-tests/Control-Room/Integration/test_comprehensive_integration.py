...
def test_control_room_imports():
    ...
    try:
        ...
        # Data sync status check removed from runtime (archived)
        print_test("_check_data_sync_status method removed (deprecated)", not has_sync_check)
...
def test_wizard_imports():
    ...
    try:
        ...
        # Save via JSON deprecated
        print_test("_save_system_via_json method removed (deprecated)", not has_save_via_json)
...
def test_data_providers():
    ...
    try:
        ...
        # JSON provider deprecated; sync tools archived and not tested
        print_test("Data sync tooling archived (check Archive-Dump)", True)
...
def test_migration_tools():
    ...
    try:
        # Migration tools are archived; confirm their presence in Archive-Dump
        archive_sqlite = Path('Archive-Dump/src/migration/json_to_sqlite.py')
        archive_import = Path('Archive-Dump/src/migration/import_json.py')
        archive_sync = Path('Archive-Dump/src/migration/sync_data.py')
        print_test("json_to_sqlite.py archived", archive_sqlite.exists())
        print_test("import_json.py archived", archive_import.exists())
        print_test("sync_data.py archived", archive_sync.exists())
...
def test_phase_integration():
    ...
    try:
        ...
        # Data sync tooling is archived; not part of runtime checks
...
def check_file_structure():
    ...
    required_files = {
        "data/data.json": "JSON data file (deprecated/archived)",
