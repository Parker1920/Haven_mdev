...
export default function QuickActions(){
  return (
    <div className="space-x-3">
      ...
      <a className="px-4 py-2 bg-neutral-200 text-gray-800 rounded hover:bg-neutral-300 inline-flex items-center" href="/map/VH-Map.html" target="_blank" rel="noreferrer"><GlobeAltIcon className="w-4 h-4 mr-2"/>Open Latest Map</a>
    </div>
  )
}
